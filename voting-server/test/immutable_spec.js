...
describe('immutability',() => {
	...
	describe('a List',() => {
		...
		function addMovie(currentState,movieName){
			return currentState.push(movieName);
		}
		...
		it('is immutable',() =>{
			...
			expect(nextState).to.equal(List.of('Trainspotting', '28 Days Later',
				'Sunshine'));
	...
	describe('a tree', () => {
		function addMovie(currentState,movieName){
			return currentState.update('movies',movies => movies.push(movieName));
		}
